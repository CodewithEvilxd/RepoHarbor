...
import (
	...
	gh "github.com/codewithevilxd/repoharbor/internal/github"
	"github.com/codewithevilxd/repoharbor/internal/ui"
)
...
Examples:
  repoharbor
  repoharbor https://github.com/torvalds/linux
  repoharbor https://github.com/rust-lang/rust/tree/master/src/tools --ref master
  repoharbor --profile work https://github.com/user/private-repo
...
Config:
  ...
  repoharbor config set path /downloads
